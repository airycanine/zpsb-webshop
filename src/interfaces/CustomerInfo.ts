...
export enum CustomerActionStatuses {
  ...
  UPDATE_CUSTOMER_ADDRESS_PENDING = "UPDATE_CUSTOMER_ADDRESS_PENDING",
  UPDATE_CUSTOMER_ADDRESS_SUCCESSFUL = "UPDATE_CUSTOMER_ADDRESS_SUCCESSFUL",
  UPDATE_CUSTOMER_ADDRESS_FAILED = "UPDATE_CUSTOMER_ADDRESS_FAILED",
  UPDATE_CUSTOMER_ADDRESS_NOT_TRIGGERED_YET = "UPDATE_CUSTOMER_ADDRESS_NOT_TRIGGERED_YET",
